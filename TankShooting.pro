...
include(TankShootingSource.pri)
include(TankShootingHeader.pri)
include(TankShootingConfig.pri)
include(TankShootingIncludes.pri)
include(TankShootingDefines.pri)
...
TankShooting-Linux-Debug.commands = $$build TankShooting Linux Debug  -project="\"$$gameProjectFile\"" $$args
TankShooting-Linux-DebugGame.commands = $$build TankShooting Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
TankShooting-Linux-Shipping.commands = $$build TankShooting Linux Shipping  -project="\"$$gameProjectFile\"" $$args
TankShooting-Linux-Test.commands = $$build TankShooting Linux Test  -project="\"$$gameProjectFile\"" $$args
TankShooting.commands = $$build TankShooting Linux Development  -project="\"$$gameProjectFile\"" $$args

TankShootingEditor-Linux-Debug.commands = $$build TankShootingEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
TankShootingEditor-Linux-DebugGame.commands = $$build TankShootingEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
TankShootingEditor-Linux-Shipping.commands = $$build TankShootingEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
TankShootingEditor-Linux-Test.commands = $$build TankShootingEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
TankShootingEditor.commands = $$build TankShootingEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	TankShooting-Linux-Debug \
	TankShooting-Linux-DebugGame \
	TankShooting-Linux-Shipping \
	TankShooting-Linux-Test \
	TankShooting \
	TankShootingEditor-Linux-Debug \
	TankShootingEditor-Linux-DebugGame \
	TankShootingEditor-Linux-Shipping \
	TankShootingEditor-Linux-Test \
	TankShootingEditor \
