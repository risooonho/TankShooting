...
UNREALROOTPATH = "/mnt/Data/Programs/UnrealEngine"
...
TankShooting-Linux-Debug:
	 $(PROJECTBUILD) TankShooting Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

TankShooting-Linux-DebugGame:
	 $(PROJECTBUILD) TankShooting Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

TankShooting-Linux-Shipping:
	 $(PROJECTBUILD) TankShooting Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

TankShooting-Linux-Test:
	 $(PROJECTBUILD) TankShooting Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

TankShooting:
	 $(PROJECTBUILD) TankShooting Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

TankShootingEditor-Linux-Debug:
	 $(PROJECTBUILD) TankShootingEditor Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

TankShootingEditor-Linux-DebugGame:
	 $(PROJECTBUILD) TankShootingEditor Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

TankShootingEditor-Linux-Shipping:
	 $(PROJECTBUILD) TankShootingEditor Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

TankShootingEditor-Linux-Test:
	 $(PROJECTBUILD) TankShootingEditor Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

TankShootingEditor:
	 $(PROJECTBUILD) TankShootingEditor Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)
